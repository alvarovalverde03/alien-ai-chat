...
export default function Home() {
  return (
    <main className='flex min-h-full max-h-dvh max-w-[900px] w-full mx-auto overflow-hidden flex-col items-center justify-between px-4 pb-2 lg:pb-6 pt-8 lg:pt-12 relative'>
